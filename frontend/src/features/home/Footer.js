    ...
    <div className="class">
     <div className="about">
          <div className="about-app">
            ...
            <h5 className="app">"No Thanks" takes the stress of going into a bad restaurant.</h5>
            <h5>We Are Dedicated To Ensure You Don't Have A Terrible Dining Experience. </h5>
            <h5>With Our Database, We Will Show You Exactly Where You Should NOT Go!</h5>
          </div>
        </div>
